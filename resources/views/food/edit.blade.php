                ...
                <form action="{{ route('food.update', $item->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-grey-600 text-xs italic">Dipisahkan dengan koma, contoh: Bawang merah, Paprika, Bawang Bombai, Timun</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-grey-600 text-xs italic">Dipisahkan dengan koma, contoh: recommended, pupolar, new_food</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
